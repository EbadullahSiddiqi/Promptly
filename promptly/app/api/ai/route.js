  ...
  try {
    ...
    if (contentType === "linkedin") {
      const parts = [
        ...
        {
          text: "input: Write a LinkedIn post about getting users for your Micro SaaS as an indie hacker. Share how you're trying to get the first users for your tool called Content Co-Pilot. Share stories of any two successful indie hackers who are running great tools and how they got users. In the end, ask for people's advice in the comments. Add a \"P.S \" line at the end. Tone: friendly, humorous",
        },
        {
          text: "output: Okay, indie hackers, level with me. Getting those first users for your Micro SaaS? It's like trying to herd cats with a laser pointer. 😼\n\nI'm currently in the \"trying not to cry\" phase with Content Co-Pilot. Building's the fun part, *finding people who actually need it?* That's the real challenge.\n\nSo, I've been shamelessly stalking... errr, I mean *studying* how other indie hackers pulled it off.\n\nTake Arvid Kahl, for example, and his FeedbackPanda! It has recurring revenue in millions with 6 employees and all they had to do was great communication, content, and patience. He focused on making the product great for existing users and made himself very much available!\nAnd @rosiesherry, co-founder of PathUnbound, always put users first in the initial stages.\n\nSee a pattern? Building an audience is important, but solving a real-world user-driven problem will get you those crucial first users.\n\nAnyway, back to the laser pointer and the cats... \n\nAnyone out there have any secret user acquisition ninjutsu to share? Throw your wisdom my way in the comments! 🙏\n\nP.S. I *swear* Content Co-Pilot is amazing. Come see! [Link to your tool]\n\n#indiehacker #microsaas #buildinpublic #saas #marketing #useracquisition",
        },
      ];
