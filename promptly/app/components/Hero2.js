    ...
    <div className="hero2 flex justify-center items-center py-20 px-4 sm:px-8">
      <div className="flex flex-col gap-7 max-w-5xl w-full">
        ...
        <p className="text-base sm:text-lg md:text-2xl text-center font-light text-gray-600">
          ...
          <br className="hidden sm:block" /> better, attractive content in just minutes with
          <br className="hidden sm:block" /> the set of Promptly's Tools.
        </p>

        {/* Features Section */}
        <div className="flex flex-col sm:flex-row lg:gap-10 justify-center items-center h-full gap-5 sm:gap-3 px-5">
          {features.map((feature, index) => (
            ...
            >
              ...
              <h2 className="font-semibold text-lg sm:text-xl">{feature.heading}</h2>
